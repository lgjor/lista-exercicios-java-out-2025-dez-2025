package org.desviante.exercicios.HyperSkill.File.FindTheGreatestNumberInAFile;
...
public class FindTheGreatestNumberInAFile {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String path = "src/main/java/org/desviante/exercicios/HyperSkill/File/FindTheGreatestNumberInAFile/dataset_91007.txt";
